...
Wickham, H. (2017). _[Advanced R](http://adv-r.had.co.nz/OO-essentials.html)_. 1st edition.

Hadley Wickham (2019). [sloop: Helpers for 'OOP' in R](https://CRAN.R-project.org/package=sloop). R package version 1.0.1. 
